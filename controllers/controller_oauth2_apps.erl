...
del_consumer(Id, Context) ->
    m_oauth2_app:delete_consumer(Id, Context),
...
event(#postback{message={start_edit_app, Arg}}, Context) ->
    ...
    Consumer = m_oauth2_app:get_consumer(Id, Context),
...
event(#submit{message={consumer_save, Arg}}, Context) ->
    ...
    Context1 = case proplists:get_value(id, Arg) of
                   undefined ->
                       Consumer = m_oauth2_app:create_consumer(Title, URL, Descr, Callback, Context),
                       m_oauth2_perms:set(z_db:get(id, Consumer), Perms, Context),
                       z_render:wire({growl, [{text, ?__("Created new application.", Context)}]}, Context);
                   
                   Id ->
                       m_oauth2_app:update_consumer(Id, [{application_title, Title},

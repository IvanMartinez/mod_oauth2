...
resource_exists(ReqData, Context) ->
    Token = m_oauth2_app:get_request_token(z_context:get_q("oauth_token", Context), Context),
    case Token of
        undefined ->
...
process_post(ReqData, Context) ->
    ...
    ?DEBUG(Token),
    m_oauth2_app:authorize_request_token(Token, Context#context.user_id, Context),

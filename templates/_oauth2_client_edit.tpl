{% wire id=#form type="submit" postback={consumer_save id=client.id} %}
            ...
            <div class="tab-pane active" id="{{ #tab }}-details">
                ...
                {% if consumer %}
                    <div class="form-group row">
                        <label for="zp-ckey" class="control-label col-md-3">{_ Client ID _}</label>
                        <div class="col-md-9">
                            <input class="form-control" type="text" id="zp-ckey" readonly value="{{ client.client_id }}" />
                        </div>
                    </div>
    
                    <div class="form-group row">
                        <label for="zp-csec" class="control-label col-md-3">{_ Client secret _}</label>
                        <div class="col-md-9">
                            <input class="form-control" type="text" id="zp-csec" readonly value="{{ client.client_secret }}" />
                        </div>
                    </div>
                {% endif %}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input class="form-control" type="text" name="zp-title" id="zp-title" value="{{ client.application_title }}" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input class="form-control" type="text" name="zp-url" id="zp-url" value="{{ client.application_uri }}" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <textarea class="form-control" name="zp-text" id="zp-text">{{ client.application_descr }}</textarea>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="zp-redirection" class="control-label col-md-3">{_ Redirection URI _}</label>
                    <div class="col-md-9">
                        <input class="form-control" type="text" name="zp-redirection" id="zp-redirection" value="{{ client.redirection_uri }}" />
                    </div>
                </div>
...
{% endjavascript %}
            ...
            <div class="tab-pane" id="{{ #tab }}-auth">
                ...
                {% with m.oauth2_perms.selected[client.id] as perms %}
                    <table class="table" >
                        {% for perm in m.oauth2_perms %}
                            <tr>
                                <td>
